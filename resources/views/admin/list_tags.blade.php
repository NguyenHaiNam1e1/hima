...
<div class="row pt-2 pb-2">
       ...
       <a href="{{URL::to('/admin/add_tags')}}"><button class="custom-btn btn-11 " >ADD<div class="dot"></div></button></a>
              ...
              <table id="example" class="table table-bordered">
               ...
               @foreach($Tags as  $tag)
                    <tr>
                        ...
                        <td>
                        <a onclick="return confirm('Are you sure to delete?')" href=" {{URL::to('/admin/delete_tags/'.$tag->id)}}" class="active" >
                        ...
                        <a href="{{URL::to('/admin/show_tags/'.$tag->id)}}" class="active" >
